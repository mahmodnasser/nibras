...
p('|---|---|---|');
p('| Areas that grow beyond 49 requirements overflow the derived range | Extend the rule into the next free range and regenerate; the generator refuses to run until then | Architect |');
p();
p('## Review record');
p();
