...
2. `docs/brief/01-master-brief.md` (v9.2): vision, rules, method. 40 sections.
3. `docs/brief/02-appendices/` (v9.2): one file per appendix, A to X. **Appendix L is the canonical registry** of service names, identifier formats and ownership decisions. Nothing redefines it.
4. `docs/brief/03-reference-architecture.md` (v9.2): structures, service sheets, topology, delivery, operations. 17 sections.
