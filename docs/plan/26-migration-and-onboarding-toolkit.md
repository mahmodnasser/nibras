...
| 2026-09-26 | Group F review, round 3 | Blocked: the group scored below 4 on Completeness, because document 31 listed no transition-test ids per workflow | None of the group's blocking gaps was in this document; `TC-DATA-800` to `TC-DATA-802` were found present; this record stopped at "awaiting the round 3 score" (Completeness, not blocking) |
