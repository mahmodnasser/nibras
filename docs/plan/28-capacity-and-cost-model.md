...
| This document agrees with the catalogs | `tools/kit-lint` for section and appendix references, forbidden words and Mermaid types; `/lint-plan` for consistency with documents 11, 15, 21 and 25 | Every change under `docs/` |
