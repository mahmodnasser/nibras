...
| 30 Which count bills a tenant | none yet | Decided by the product owner. The default in force is master brief Section 36 and REQ-PLT-009 (students enrolled on the billing date, prorated by day); BR-FIN-017 and SL-PLT-010 conflict with it until decided, and the correction of BR-FIN-017 needs a record with a brief version bump. RISK-52; in the table of decisions to come |
...
| The count that bills a tenant | `06-services/finance.md` open point 3; built on by `34-work-breakdown.md` SL-PLT-010 | Correcting BR-FIN-017 in Appendix S needs a record and a version bump | Master brief Section 36 and REQ-PLT-009: students enrolled on the billing date, prorated by day; BR-FIN-017 and SL-PLT-010 conflict with it until decided. RISK-52 | Open question 30 |
