...
**Group** A, updated last as PLAN_SPEC requires ("F: 22 to 33, 34, then update 00") · **Requirement areas covered** none of its own; it quotes Appendix L and documents 01, 03, 05, 15, 17, 18, 28, 29, 30, 32 and 34 · **Last updated** 2026-09-26, after Open Question 30 was decided (ADR-0027) and the product owner approved the plan
