...
| 2 | Teacher, phone | Opens **five-minute mode**. The register for 4B is already three-quarters filled from the gate scan and two approved leaves. Confirms four exceptions. Total elapsed on screen: under twenty seconds | 26, 34, 3 | TC-ATT-812 | 2, at the MVP cut line, whose request subset supplies the approved leaves |
...
| 13 | Security officer, tablet | Triggers **emergency mode**. The staff app switches to roll call by location, acknowledgements stream in, the "not yet accounted for" list shrinks, and the minute ends on reunification verifying one pickup | 32, 8 | TC-ATT-813 | 2 |
