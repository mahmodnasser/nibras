...
| 3 | Sixty-second attendance | "Done before the bell stopped" | 1 | 1 surfaces | 1 | Attendance | TC-ATT-001 |
...
| 6 | Report Card Studio with QR verification | "Eight hundred report cards, verified" | 1, comments at 3 | 3 drafts | 1 | Assessment | TC-ASM-001 |
| 7 | Parent experience that respects attention | "One calm message, not twelve" | 1 | 1 surfaces | 1 | Notification | TC-NOT-001 |
| 8 | Safety and dismissal with gate passes | "I know who collected the child" | 1 | 1 surfaces | 1 | Attendance | TC-ATT-002 |
...
| 18 | Student portfolio and recognition | "Everything they achieved, theirs to keep" | 1 | 1 surfaces | 2 | Behavior | TC-BEH-001 |
| 19 | Kindergarten daily sheet | "I know how the day went" | 1 | 1 surfaces | 2 | Academics | TC-ACA-001 |
| 20 | Balanced class formation | "Fair classes in one pass, then adjusted by hand" | 1 | 1 surfaces | 2 | School | TC-SCH-001 |
...
| 26 | Exception-only attendance | "The register was already half filled" | 1 | 4 acts, the pre-fill only | 1 | Attendance | TC-ATT-003 |
...
| 30 | Intervention playbooks | "A flag became a plan with an owner" | 1 | 3 drafts | 1 | Wellbeing | TC-WEL-001 |
| 31 | Guardian transparency on sensitive access | "I can see who looked at my child's file" | 1 | 1 surfaces | 1 | Audit | TC-AUD-002 |
| 32 | Emergency mode with reunification | "Every child accounted for in four minutes" | 1 | 1 surfaces | 1 | Attendance | TC-ATT-004 |
| 33 | Campus digital twin | "I saw the empty rooms at a glance" | 1 | 1 surfaces | 2 | Operations | TC-OPS-001 |
...
| 42 | Mastery and next step | "I saw the gap and what to teach next" | 2, degrades to the raw heatmap | 2 suggests | 2 | Assessment | TC-ASM-002 |
| 43 | Workload balance for staff | "Someone noticed before I burned out" | 2, degrades to load totals | 2 suggests | 2 | Hr | TC-HR-001 |
