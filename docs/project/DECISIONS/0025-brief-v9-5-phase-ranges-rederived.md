...
The round-4 scorecard (`docs/plan/30-plan-scorecard.md`) blocked Group F because SL-ACA-207 built the LTI 1.3 launch in phase 2, before the registration, login and keys that SL-INT-411 builds in phase 4. It also found that SL-FIN-444, a 3-day slice, carried the first e-invoicing plug-in with no estimate. Remediation round 5 split the launch into SL-ACA-405 under CAP-INT-02 (phase 4) and added the conditional e-invoicing slices SL-FIN-448 to SL-FIN-452 (phase 3) for the default countries of Open Question 3, each conditional on Open Question 9 deciding that e-invoicing plug-ins are built in phase 3 and on Open Question 3 recording a VAT-registered first customer in its country. Document 34 now holds 79 capabilities, 724 slices and 1,721 slice-days, and `schedule-34.mjs` gives phase 3 11 to 18 weeks, phase 4 7 to 12 weeks and a total of 61 to 95 weeks. The brief still said 11 to 17, 7 to 11 and 61 to 93, so the brief and the plan disagreed.
...
- **Absorb the new slices into the overhead factor.** Rejected. It is an adjustment by hand, and it hides the e-invoicing work that Open Questions 3 and 9 make conditional.
...
- If Open Question 3 removes a country, or Open Question 9 keeps e-invoicing plug-ins at their phase 5 default, the conditional slices concerned leave phase 3 of document 34 and the ranges are recomputed again under a new record.
- Remediation round 6 (2026-09-26) added SL-INT-412 and SL-ASM-400, LTI Assignment and Grade Services, under CAP-INT-02: 3 slice-days in phase 4, 726 slices and 1,724 slice-days in all. `schedule-34.mjs` still gives phase 4 7 to 12 weeks and a total of 61 to 95, so the brief figures of this record stand unchanged.
